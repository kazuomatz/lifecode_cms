...
LifeCode CMSは、Webアプリケーションのコンテンツの管理システムを素早く構築するためのフレームワークを実装しています。
...
## LifeCode CMSを使用したWebアプリケーション開発者の対象
...
ただし、同じRailsアプリケーション内にエンドユーザー向けの画面については、NuxtJSで構築するといった開発方法は可能です。
...
|column| カラム数です。LifeCode CMS はBootstrapのレイアウトを採用しているので、BootstrapのGridシステムのカラム数を設定します。4〜12が打倒な値です。|
...
##### ラジオボタングループ
  ...
  <img src="https://user-images.githubusercontent.com/2704723/79063289-a10eb880-7cdb-11ea-96e2-2c9bef99666f.jpg" width='30%'/>
...
いちばんシンプルな形です。date_uiが :calendar(デファオルト）に設定されていると、テキストフィールドをクリックするとカレンダーが表示されるUIが生成されます。
...
日付を年月日にわけてプルダウンで選択するUIが生成されます。
  ...
  <img src="https://user-images.githubusercontent.com/2704723/79063902-a79f2f00-7cdf-11ea-9302-2ebdf53ee807.jpg" width='35%'/>
...
eraをtrueにすると、元号が合わせて表示されます。
  ...
  <img src="https://user-images.githubusercontent.com/2704723/79064068-a1f61900-7ce0-11ea-9848-8af30ab6fb2d.jpg" width='35%'/>
