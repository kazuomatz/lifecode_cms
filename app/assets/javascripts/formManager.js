    ...
    LCForm.prototype.init = function (el) {
        ...
        if ($el.find('._select2').length > 0) {
            if($el.find('._select2').data('ajax')){
                ...
                var object = $el.find('._select2').data('object');
                var textName = $el.find('._select2').data('text-name');
                var option_items = $el.find('._select2').data('option-items');
                var selectMessage = $el.find('._select2').data('select-message');
